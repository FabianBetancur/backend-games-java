...
public class PaymentTransactionsControllerPost {
    ...
    public ResponseEntity<?> saveTransaction(@RequestBody PaymentTransactionsDto request){
        try {
            if(request.getCartId() == null || request.getTotalAmount() == null){
            ...
            return ResponseEntity.status(HttpStatus.OK)
                    .body(new HashMap<String,String>(){{
                        put("message","transaction generated successfully");
                    }});
        } catch (Exception ex){
